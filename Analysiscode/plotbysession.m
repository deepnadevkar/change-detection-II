...
% % behavioral plots % plots all species (Humans, M1, M2, and M3) set size
% % plots
% 
% figure;
...
% hold on;
% errorbar(repmat(condvec,3,1)', datacond_meanall', datacond_steall','-o'); hold on;
% xlabel('Condition'); ylabel('Proportion correct');axis([0.8 4.2 0.4 1.0])
% set(gca,'YTick',0.4:.2:1.0)
% set(gca,'XTick', 1:1:4)
% legend(strcat('Condition = ',int2str(condvec')), 3);
