%function [VSO1, VSO2, VEO1, VEO2, VVO1, VVO2, pars_VSO, pars_VEO, pars_VVO, LL, BMC, BIC, AIC, AICc, Rs_VSO, Rs_VEO, Rs_VVO] = modelfitting(fakedata)

tic
load fakedatasetsnew_VVO
sessions = datasets;
...
for sind = 1:1:length(sessions)
    ...
    filename = strcat('modelfitsVVOnew_',num2str(sind))
